...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        h7 = self.addHost('h7', ip='10.3.0.7')
        h8 = self.addHost('h8', ip='10.3.0.8')
        h9 = self.addHost('h9', ip='10.3.0.9')
        h10 = self.addHost('h10', ip='10.3.0.10')
        h11 = self.addHost('h11', ip='10.3.0.11')
        h12 = self.addHost('h12', ip='10.3.0.12')
        h13 = self.addHost('h13', ip='10.3.0.13')
        h14 = self.addHost('h14', ip='10.3.0.14')
        h15 = self.addHost('h15', ip='10.3.0.15')
        h16 = self.addHost('h16', ip='10.3.0.16')
        h17 = self.addHost('h17', ip='10.3.0.17')
        h18 = self.addHost('h18', ip='10.3.0.18')
        h19 = self.addHost('h19', ip='10.3.0.19')
        h20 = self.addHost('h20', ip='10.3.0.20')
        h21 = self.addHost('h21', ip='10.3.0.21')
        h22 = self.addHost('h22', ip='10.3.0.22')
