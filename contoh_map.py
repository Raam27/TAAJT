...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        h5 = self.addHost('h5', ip='10.0.0.5', mac='000000000005')
        h6 = self.addHost('h6', ip='10.0.0.6', mac='000000000006')
        h7 = self.addHost('h7', ip='10.0.0.7', mac='000000000007')
        h8 = self.addHost('h8', ip='10.0.0.8', mac='000000000008')
        h9 = self.addHost('h9', ip='10.0.0.9', mac='000000000009')
        h10 = self.addHost('h10', ip='10.0.0.10', mac='000000000010')
        h11 = self.addHost('h11', ip='10.0.0.11', mac='000000000011')
        h12 = self.addHost('h12', ip='10.0.0.12', mac='000000000012')
        h13 = self.addHost('h13', ip='10.0.0.13', mac='000000000013')
        h14 = self.addHost('h14', ip='10.0.0.14', mac='000000000014')
        h15 = self.addHost('h15', ip='10.0.0.15', mac='000000000015')
        h16 = self.addHost('h16', ip='10.0.0.16', mac='000000000016')
        h17 = self.addHost('h17', ip='10.0.0.17', mac='000000000017')
        h18 = self.addHost('h18', ip='10.0.0.18', mac='000000000018')
        h19 = self.addHost('h19', ip='10.0.0.19', mac='000000000019')
        h20 = self.addHost('h20', ip='10.0.0.20', mac='000000000020')
        h21 = self.addHost('h21', ip='10.0.0.21', mac='000000000021')
        h22 = self.addHost('h22', ip='10.0.0.22', mac='000000000022')
